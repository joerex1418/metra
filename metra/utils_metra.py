...
STOPS_TXT_PATH = os.path.join(os.path.dirname(__file__), 'metra_google_transit/stops.txt')
STOP_TIMES_TXT_PATH = os.path.join(os.path.dirname(__file__), 'metra_google_transit/stop_times.txt')
TRIPS_TXT_PATH = os.path.join(os.path.dirname(__file__), 'metra_google_transit/trips.txt')
SHAPES_TXT_PATH = os.path.join(os.path.dirname(__file__), 'metra_google_transit/shapes.txt')
ROUTES_TXT_PATH = os.path.join(os.path.dirname(__file__), 'metra_google_transit/routes.txt')
CALENDAR_TXT_PATH = os.path.join(os.path.dirname(__file__), 'metra_google_transit/calendar.txt')
CALENDAR_DATES_TXT_PATH = os.path.join(os.path.dirname(__file__), 'metra_google_transit/calendar_dates.txt')
FARE_RULES_TXT_PATH = os.path.join(os.path.dirname(__file__), 'metra_google_transit/fare_rules.txt')
FARE_ATTRIBUTES_TXT_PATH = os.path.join(os.path.dirname(__file__), 'metra_google_transit/fare_attributes.txt')
TODAY_TXT_PATH = os.path.join(os.path.dirname(__file__), 'metra_google_transit/today.txt')
...
def check_feed():
    ...
    # with open(os.path.abspath("./metra/metra/metra_google_transit/today.txt")) as txtfile:
...
def get_static_stops(__dlmode=True):
    if __dlmode is True:
        ...
        df.to_csv(STOPS_TXT_PATH,index=False)
        # df.to_csv(os.path.abspath("./metra/metra/metra_google_transit/stops.txt"),index=False)
    else:
        return pd.read_csv(STOPS_TXT_PATH,index_col=False,dtype="str")
        # return pd.read_csv(os.path.abspath("./metra/metra/metra_google_transit/stops.txt"),index_col=False,dtype="str")
...
def get_static_stop_times(__dlmode=True):
    if __dlmode is True:
        ...
        df.to_csv(STOP_TIMES_TXT_PATH,index=False)
        # df.to_csv(os.path.abspath("./metra/metra/metra_google_transit/stop_times.txt"),index=False)
    else:
        return pd.read_csv(STOP_TIMES_TXT_PATH,index_col=False,dtype="str")
        # return pd.read_csv(os.path.abspath("./metra/metra/metra_google_transit/stop_times.txt"),index_col=False,dtype="str")
...
def get_static_trips(__dlmode=True):
    if __dlmode is True:
        ...
        df.to_csv(TRIPS_TXT_PATH,index=False)
        # df.to_csv(os.path.abspath("./metra/metra/metra_google_transit/trips.txt"),index=False)
    else:
        df = pd.read_csv(TRIPS_TXT_PATH,index_col=False,dtype="str")
        # df = pd.read_csv(os.path.abspath("./metra/metra/metra_google_transit/trips.txt"),index_col=False,dtype="str")
        return df
...
def get_static_shapes(__dlmode=True):
    if __dlmode is True:
        ...
        df.to_csv(SHAPES_TXT_PATH,index=False)
        # df.to_csv(os.path.abspath("./metra/metra/metra_google_transit/shapes.txt"),index=False)
    else:
        df = pd.read_csv(SHAPES_TXT_PATH,index_col=False,dtype="str")
        # df = pd.read_csv(os.path.abspath("./metra/metra/metra_google_transit/shapes.txt"),index_col=False,dtype="str")
        return df
...
def get_static_routes(__dlmode=True):
    if __dlmode is True:
        ...
        df.to_csv(ROUTES_TXT_PATH,index=False)
        # df.to_csv(os.path.abspath("./metra/metra/metra_google_transit/routes.txt"),index=False)
    else:
        df = pd.read_csv(ROUTES_TXT_PATH,index_col=False,dtype="str")
        # df = pd.read_csv(os.path.abspath("./metra/metra/metra_google_transit/routes.txt"),index_col=False,dtype="str")
        return df
...
def get_static_calendar(__dlmode=True):
    if __dlmode is True:
        ...
        df.to_csv(CALENDAR_TXT_PATH,index=False)
        # df.to_csv(os.path.abspath("./metra/metra/metra_google_transit/calendar.txt"),index=False)
    else:
        df = pd.read_csv(CALENDAR_TXT_PATH,index_col=False,dtype="str")
        # df = pd.read_csv(os.path.abspath("./metra/metra/metra_google_transit/calendar.txt"),index_col=False,dtype="str")
        return df
...
def get_static_calendar_dates(__dlmode=True):
    if __dlmode is True:
        ...
        df.to_csv(CALENDAR_DATES_TXT_PATH,index=False)
        # df.to_csv(os.path.abspath("./metra/metra/metra_google_transit/calendar_dates.txt"),index=False)
    else:
        df = pd.read_csv(CALENDAR_DATES_TXT_PATH,index_col=False,dtype="str")
        # df = pd.read_csv(os.path.abspath("./metra/metra/metra_google_transit/calendar_dates.txt"),index_col=False,dtype="str")
        return df
...
def get_static_fare_rules(__dlmode=True):
    if __dlmode is True:
        ...
        df.to_csv(FARE_RULES_TXT_PATH,index=False)
        # df.to_csv(os.path.abspath("./metra/metra/metra_google_transit/fare_rules.txt"),index=False)
    else:
        df = pd.read_csv(FARE_RULES_TXT_PATH,index_col=False,dtype="str")
        # df = pd.read_csv(os.path.abspath("./metra/metra/metra_google_transit/fare_rules.txt"),index_col=False,dtype="str")
        return df
...
def get_static_fare_attributes(__dlmode=True):
    if __dlmode is True:
        ...
        df.to_csv(FARE_ATTRIBUTES_TXT_PATH,index=False)
        # df.to_csv(os.path.abspath("./metra/metra/metra_google_transit/fare_attributes.txt"),index=False)
    else:
        df = pd.read_csv(FARE_ATTRIBUTES_TXT_PATH,index_col=False,dtype="str")
        # df = pd.read_csv(os.path.abspath("./metra/metra/metra_google_transit/fare_attributes.txt"),index_col=False,dtype="str")
        return df
...
def update_static_feed():
    ...
    with open(TODAY_TXT_PATH,"w+") as txtfile:
        txtfile.write(check_feed())
    # with open(os.path.abspath("./metra/metra/metra_google_transit/today.txt"),"w+") as txtfile:
    #     txtfile.write(check_feed())
